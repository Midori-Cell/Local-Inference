...
const max_tokens = __ENV.SERVER_BENCH_MAX_TOKENS ? parseInt(__ENV.SERVER_BENCH_MAX_TOKENS) : 2048

// Max prompt tokens
const n_prompt_tokens = __ENV.SERVER_BENCH_MAX_PROMPT_TOKENS ? parseInt(__ENV.SERVER_BENCH_MAX_PROMPT_TOKENS) : 2048

// Max slot context
const n_ctx_slot = __ENV.SERVER_BENCH_MAX_CONTEXT ? parseInt(__ENV.SERVER_BENCH_MAX_CONTEXT) : 4096
...
export const options = {
    thresholds: {
        llamacpp_completions_truncated_rate: [
            ...
            {threshold: 'rate < 0.8', abortOnFail: false, delayAbortEval: '1m'},
        ],
    },
    duration: '10m',
    vus: 8,
